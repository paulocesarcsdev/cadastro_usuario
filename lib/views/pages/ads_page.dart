...
import 'package:cadastro_usuario/views/pages/home_page.dart';
import 'package:cadastro_usuario/views/pages/login_page.dart';
...
class _AdsPageState extends State<AdsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<AdsProviderController>(
